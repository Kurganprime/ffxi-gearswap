...
--	Rawhide_Boots_B  = {name="Rawhide Boots", augments={'HP+50','Accuracy+15','Evasion+20'}}
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        ...
        back="Iximulew Cape",waist="Chaac Belt",legs="Hachiya Hakama +1",feet="Mochizuki Kyahan +1"}
		--{ammo="Sonia's Plectrum",
        --head="Felistris Mask",
        --body="Hachiya Chainmail",hands="Buremte Gloves",ring1="Spiral Ring",
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, 
		{neck="Magoraga Beads",body="Mochizuki Chainmail +1",back="Andartia's Mantle"})
	sets.precast.FC.ElementalNinjutsu = set_combine(sets.precast.FC, {feet="Mochizuki Kyahan +1"})
    ...
    sets.precast.WS = {
        ...
        --body="Taeon Tabard",hands="Mochizuki Tekko",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS,
        {head="Adhemar Bonnet",ear2="Moonshade Earring",hands="Hachiya Tekko +1",feet="Hattori Kyahan +1"})
    ...
    sets.midcast.FastRecast = {
        head="Hattori Zukin +1",ear2="Loquacious Earring",
        body="Hachiya Chainmail +1",hands="Mochizuki Tekko +1",ring1="Prolix Ring",
        waist="Hurch'lan Sash",legs="Hattori Hakama +1",feet="Daihanshi Habaki"}
		--{
        --head="Felistris Mask",ear2="Loquacious Earring",
        --body="Hachiya Chainmail",hands="Mochizuki Tekko",ring1="Prolix Ring",
        --legs="Hachiya Hakama",feet="Qaaxo Leggings"}
        
    sets.midcast.Utsusemi = set_combine(sets.midcast.SelfNinjutsu, 
		{feet="Hattori Kyahan +1",back="Andartia's Mantle"})

    sets.midcast.ElementalNinjutsu = {
        head="Hizamaru Somen +2",neck="Sanctity Necklace",ear1="Friomisi Earring",ear2="Hecate's Earring",
        ...
        --body="Hachiya Chainmail",hands="Iga Tekko +2",ring1="Icesoul Ring",ring2="Acumen Ring",
    ...
    sets.midcast.NinjutsuBuff = {head="Mochizuki Hatsuburi +1",neck="Ej Necklace",back="Yokaze Mantle"}
    ...
    sets.midcast.RA = {
		...
		--{
        --head="Felistris Mask",neck="Ej Necklace",
        --body="Hachiya Chainmail",hands="Hachiya Tekko",ring1="Beeline Ring",
        --back="Yokaze Mantle",legs="Nahtirah Trousers",feet="Qaaxo Leggings"}
    ...
    -- Idle sets
    sets.idle = {
        head="Hizamaru Somen +2",neck="Sanctity Necklace",ear1="Infused Earring",ear2="Heartseeker Earring",
        body="Hizamaru Haramaki +2",hands="Adhemar Wristbands",ring1="Sheltered Ring",ring2="Paguroidea Ring",
	...
	sets.idle.Town = {main="Kikoku",sub="Shigi",ammo="Togakushi Shuriken",
        head="Hizamaru Somen +2",neck="Sanctity Necklace",ear1="Infused Earring",ear2="Heartseeker Earring",
        body="Hizamaru Haramaki +2",hands="Hizamaru Kote +2",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Yokaze Mantle",waist="Flume Belt",legs="Hizamaru Hizayoroi +2",feet=gear.MovementFeet}
    ...
    sets.idle.Weak = {
        head="Mochizuki Hatsuburi +1",neck="Sanctity Necklace",ear1="Infused Earring",ear2="Heartseeker Earring",
    ...
    sets.MoveSpeedDay = {feet = gear.DayFeet,}
    sets.MoveSpeedNight = {feet = gear.NightFeet,}
	
    sets.TreasureHunter = {waist="Chaac Belt",}
   
    -- Defense sets
    sets.defense.Evasion = {
        head="Mochizuki Hatsuburi +1",neck="Ej Necklace",ear1="Infused Earring",ear2="Phawaylla Earring",
        body="Taeon Tabard",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Flume Belt",legs="Mochizuki Hakama +1",feet=gear.MovementFeet}
		--{
        --head="Felistris Mask",neck="Ej Necklace",
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Hachiya Hatsuburi +1",neck="Twilight Torque",
    ...
    sets.defense.MDT = {
        head="Mochizuki Hatsuburi +1",neck="Twilight Torque",
    ...
    sets.engaged.Acc = set_combine(sets.engaged,
		{head="Whirlpool Mask",neck="Ej Necklace",back="Yokaze Mantle",waist="Hurch'lan Sash",legs="Taeon Tights"})
		--{ammo="Qirmiz Tathlum",
    ...
    sets.engaged.Acc.PDT = {ammo="Togakushi Shuriken",
        head="Mochizuki Hatsuburi +1",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Mochizuki Chainmail +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Evasion.HighHaste = {ammo="Togakushi Shuriken",
        ...
        back="Yokaze Mantle",waist="Patentia Sash",legs="Mochizuki Hakama +1",feet="Herculean Boots"}
		--{ammo="Qirmiz Tathlum",
        --head="Whirlpool Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        --body="Hachiya Chainmail",hands="Otronif Gloves",ring1="Beeline Ring",ring2="Epona's Ring",
        --back="Yokaze Mantle",waist="Patentia Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
    sets.engaged.Acc.Evasion.HighHaste = {ammo="Togakushi Shuriken",
        head="Hizamaru Somen +2",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.PDT.HighHaste = {ammo="Togakushi Shuriken",
        head="Hachiya Hatsuburi +1",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.Evasion.EmbravaHaste = {ammo="Togakushi Shuriken",
        head="Mochizuki Hatsuburi +1",neck="Ej Necklace",ear1="Infused Earring",ear2="Phawaylla Earring",
        body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Windbuffet Belt +1",legs="Hachiya Hakama +1",feet="Herculean Boots"}
		--{ammo="Qirmiz Tathlum",
        --head="Whirlpool Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        --body="Otronif Harness +1",hands="Otronif Gloves",ring1="Beeline Ring",ring2="Epona's Ring",
    ...
    sets.engaged.PDT.EmbravaHaste = {ammo="Togakushi Shuriken",
        head="Hachiya Hatsuburi +1",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Hachiya Chainmail +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Windbuffet Belt +1",legs="Hachiya Hakama +1",feet="Mochizuki Kyahan +1"}
		--{ammo="Qirmiz Tathlum",
        --head="Whirlpool Mask",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        --body="Otronif Harness +1",hands="Otronif Gloves",ring1="Defending Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Acc.Evasion.MaxHaste = {ammo="Togakushi Shuriken",
        head="Hizamaru Somen +2",neck="Ej Necklace",ear1="Steelflash Earring",ear2="Heartseeker Earring",
        body="Taeon Tabard",hands="Adhemar Wristbands",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Hurch'lan Sash",legs="Hachiya Hakama +1",feet="Herculean Boots"}
		--{ammo="Qirmiz Tathlum",
        --head="Whirlpool Mask",neck="Ej Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
    ...
    sets.engaged.PDT.MaxHaste = {ammo="Togakushi Shuriken",
        head="Hachiya Hatsuburi +1",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Hachiya Chainmail +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Windbuffet Belt +1",legs="Hachiya Hakama +1",feet="Mochizuki Kyahan +1"}
		--{ammo="Qirmiz Tathlum",
    ...
    sets.engaged.Acc.PDT.MaxHaste = {ammo="Togakushi Shuriken",
        head="Mochizuki Hatsuburi +1",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Hachiya Chainmail +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Hurch'lan Sash",legs="Hachiya Hakama +1",feet="Herculean Boots"}
		--{ammo="Qirmiz Tathlum",
        --head="Whirlpool Mask",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
