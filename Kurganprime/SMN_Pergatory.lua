...
function get_sets()
	...
	sets.TH = {
		head="Volte Cap", --Dyna D Jeuno
		waist="Chaac Belt",
		body="Nyame Mail", -- Because otherwise Cohort Cloak and such mess up the swap
		hands="Volte Bracers", --Dyna D Jeuno
		feet="Volte Boots" --Dyna D Jeuno
	}
	...
	sets.precast.FC = {
		...
		--ammo="Sapience Orb",
		head="Amalric Coif +1", -- +11  Venerian Abj. Head + Jinxed Coif
		neck="Orunmila's Torque", -- +5
		ear1="Malignance Earring", -- +4  Lillith HTBF
    ...
    sets.midcast.BP = {
		main={ name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}}, -- 200 DI points or Geas Fete, Escha Ru'Aun, Hanbi
		sub="Vox Grip", -- Abyssea Vunkerl, Khalkotaur
		ammo="Sancus Sachet +1", -- Crafted, purchased
    ...
    sets.midcast.Siphon = {
		...
		sub="Vox Grip", -- Abyssea Vunkerl, Khalkotaur
		ammo="Esper Stone +1", -- Walk of Echoes, Purchased
	...
	sets.midcast.Cursna = set_combine(sets.precast.FC, {
		neck="Debilis Medallion", -- Crafted, purchased
		ear1="Meili Earring", -- 600 DI points
		ear2="Beatific Earring", -- Meeble Burrows 20k research marks
		ring1="Menelaus's Ring", -- AMAN Trove
		ring2="Haoma's Ring", -- Crafted, purchased
		back="Tempered Cape +1", -- Walk of Echoes, purchased
		waist="Bishop's Sash", -- HKCNM 30, Boneyard Gully
	...
	sets.midcast.Enfeeble = {
		...
		ear1="Malignance Earring", -- Lillith HTBF
	...
	sets.midcast.Enhancing = {
		...
		legs={ name="Telchine Braconi", augments={'Mag. Evasion+25','"Conserve MP"+4','Enh. Mag. eff. dur. +10',}}, -- Alluvion Skirmish, Yorcia Weald
	...
	sets.midcast.Nuke = {
		...
		ring2="Shiva Ring +1", -- Crafted, purchased
		back={ name="Campestres's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Mag.Atk.Bns."+10','Phys. dmg. taken-10%',}}, -- Ambuscade
	...
	sets.pet_midcast.Physical_BP = {
		...
		ammo="Epitaph", -- Odyssey, Sgili
		head={ name="Helios Band", augments={'Pet: Attack+30 Pet: Rng.Atk.+30','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}}, -- Alluvion Skirmish, Yorcia Weald
		neck="Summoner's Collar +2", -- Crafted, purchased $$$$
		...
		ring2="Varar Ring +1", -- Crafted, purchased
	...
	sets.aftercast.PetDT.Avatar = {
		...
		body={ name="Apo. Dalmatica +1", augments={'Summoning magic skill +20','Enmity-6','Pet: Damage taken -4%',}}, -- Abyssean Abj. Body + Voodoo Dalmatica, Path D
		hands={ name="Telchine Gloves", augments={'Pet: DEF+17','Pet: "Regen"+3','Pet: Damage taken -4%',}}, -- Alluvion Skirmish, Yorcia Weald
		ring1="Thurandaut Ring +1", -- Adoulin Ring + Ygnas Directive upgrade
		ring2={name="Stikini Ring +1", bag="wardrobe4"}, -- Crafted, purchased
		back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Regen"+10','Pet: Damage taken -5%',}}, -- Ambuscade
		waist="Isa Belt", -- Delve Fracture, Kamihr Drifts, Utkux
		legs="Enticer's Pants", -- Sinister Reign, Arciela
		feet={ name="Telchine Pigaches", augments={'Pet: DEF+14','Pet: "Regen"+3','Pet: Damage taken -4%',}} -- Alluvion Skirmish, Yorcia Weald
	}
	...
	sets.aftercast.PetDD.Avatar = set_combine(sets.aftercast.Avatar, {
		...
		body="Glyphic Doublet +3",
		hands={ name="Helios Gloves", augments={'Pet: Accuracy+22 Pet: Rng. Acc.+22','Pet: "Dbl. Atk."+8','Pet: Haste+6',}}, -- Alluvion Skirmish, Yorcia Weald
		waist="Klouskap Sash", -- Crafted, purchased
		feet={ name="Helios Boots", augments={'Pet: Accuracy+21 Pet: Rng. Acc.+21','Pet: "Dbl. Atk."+8','Pet: Haste+6',}} -- Alluvion Skirmish, Yorcia Weald
	})
