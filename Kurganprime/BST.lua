...
function init_gear_sets()
    ...
    Pet_PDT_feet = {name="Acro Leggings", augments={'Pet: DEF+25','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    ...
    Ready_Atk_body = {name="Acro Surcoat", augments={'Pet: Accuracy+24 Pet: Rng.Acc.+24','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}
    Ready_Atk_hands = {name="Acro Gauntlets", augments={'Pet: Attack+25 Pet: Rng.Atk.+25','Pet: "Dbl. Atk."+5',}}
    Ready_Atk_legs = {name="Taeon Tights", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}
    Ready_Atk_feet = {name="Taeon Boots", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}
    ...
    Ready_MAB_hands = {name="Acro Gauntlets", augments={'Pet: "Mag.Atk.Bns."+20','Pet: "Store TP"+3',}}
    ...
    Ready_Atk_Axe = {name="Kumbhakarna", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: "Dbl.Atk."+2 Pet: Crit.hit rate +2','Pet: TP Bonus+180',}}
    ...
    MAB_head = {name="Taeon Chapeau", augments={'"Mag.Atk.Bns."+19','"Fast Cast"+4','Weapon skill damage +2%',}}
    MAB_body = {name="Taeon Tabard", augments={'"Mag.Atk.Bns."+20','"Fast Cast"+5','Weapon skill damage +2%',}}
    MAB_hands = {name="Taeon Gloves", augments={'"Mag.Atk.Bns."+20','"Fast Cast"+4','Weapon skill damage +3%',}}
    ...
    sets.midcast.Pet.MagicAtkReadyDWNE = set_combine(sets.midcast.Pet.MagicAtkReadyNE, {main="Aymur",sub=Ready_MAB_Axe})
    sets.midcast.Pet.MagicAtkReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.MedAcc, {main="Aymur",sub=Ready_MAB_Axe})
    sets.midcast.Pet.MagicAtkReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.HighAcc, {main="Aymur",sub=Ready_MAcc_Axe})
