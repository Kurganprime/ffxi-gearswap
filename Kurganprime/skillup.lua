...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{'Geo-Refresh','Indi-Voidance','Indi-Precision'},
        Enhancing = T{'Baraero','Barblizzard','Barfire','Barstone','Barthunder','Barwater'},
        Ninjutsu = T{},
        Singing = T{
			"Army's Paeon VI","Army's Paeon V","Army's Paeon IV","Army's Paeon III","Army's Paeon II","Army's Paeon",
			"Mage's Ballad III","Mage's Ballad II","Mage's Ballad",
			"Knight's Minne V","Knight's Minne IV","Knight's Minne III","Knight's Minne II","Knight's Minne",
			"Valor Minuet V","Valor Minuet IV","Valor Minuet III","Valor Minuet II","Valor Minuet",
			"Blade Madrigal","Sword Madrigal",
			"Dragonfoe Mambo","Sheepfoe Mambo",
			"Victory March","Advancing March",
			"Fire Carol","Ice Carol","Wind Carol","Earth Carol","Lightning Carol","Water Carol","Light Carol","Dark Carol",
		},
        Blue = T{},
        Summoning = T{
			"Fire Spirit","Ice Spirit","Air Spirit","Earth Spirit","Water Spirit","Carbuncle","Fenrir","Ifrit",
			"Titan","Leviathan","Garuda","Shiva","Ramuh","Diabolos","Cait Sith"
		}
	},
...
function get_sets()
    ...
    gs_skillup.box={pos={x=811,y=152},text={font='Segoe UI Symbol',size=12,Fonts={'sans-serif'},},bg={alpha=255}}
