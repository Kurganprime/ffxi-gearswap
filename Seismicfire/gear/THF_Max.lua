function init_gear_sets()
    ...
    sets.buff['Sneak Attack'] = {ammo="Qirmiz Tathlum",
        ...
        back="Bleating Mantle",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Plunderer's Poulaines"}
		--{ammo="Qirmiz Tathlum",
        --head="Pillager's Bonnet +1",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        ...
        back="Iximulew Cape",waist="Caudata Belt",legs="Pillager's Culottes +1",feet="Rawhide Boots"}
    ...
    sets.midcast.Utsusemi = {
        ...
        body="Pillager's Vest +1",hands="Adhemar Wristbands",ring1="Beeline Ring",
        back="Canny Cape",feet="Iuitl Gaiters"}
		--{
        --head="Whirlpool Mask",neck="Ej Necklace",ear2="Loquacious Earring",
    ...
    sets.idle = {ammo="Thew Bomblet",
        ...
        body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Shadow Mantle",waist="Windbuffet Belt +1",legs="Herculean Trousers",feet="Skadi's Jambeaux +1"}
		--{ammo="Thew Bomblet",
    ...
    sets.idle.Town = {main="Taming Sari", sub="Sandung",ammo="Thew Bomblet",
        head="Adhemar Bonnet",neck="Sanctity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Adhemar Jacket",hands="Plunderer's Armlets +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Canny Cape",waist="Windbuffet Belt +1",legs="Herculean Trousers",feet="Skadi's Jambeaux +1"}
    ...
    sets.idle.Weak = {ammo="Thew Bomblet",
        ...
        body="Pillager's Vest +1",hands="Buremte Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.defense.Evasion = {
        head="Pillager's Bonnet +1",neck="Ej Necklace",ear1="Infused Earring",ear2="Phawaylla Earring",
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        back="Iximulew Cape",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Herculean Boots"}
		--{ammo="Iron Gobbet",
        --head="Pillager's Bonnet +1",neck="Twilight Torque",
        --body="Iuitl Vest",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2=gear.DarkRing.physical,
    ...
    sets.defense.MDT = {ammo="Demonry Stone",
        ...
        back="Engulfer Cape",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Herculean Boots"}
		--{ammo="Demonry Stone",
        --head="Pillager's Bonnet +1",neck="Twilight Torque",
        --body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Shadow Ring",
    ...
    sets.engaged.Mod = {ammo="Thew Bomblet",
        ...
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs=gear.AugQuiahuiz,feet="Herculean Boots"}
		--{ammo="Thew Bomblet",
        --head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.Mod2 = {ammo="Thew Bomblet",
        ...
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs="Pillager's Culottes +1",feet="Herculean Boots"}
		--{ammo="Thew Bomblet",
        --head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.Acc.Evasion = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Pillager's Vest +1",hands="Adhemar Wristbands",ring1="Beeline Ring",ring2="Epona's Ring",
